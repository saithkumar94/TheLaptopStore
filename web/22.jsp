   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/22.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : Toshiba Satellite L75-C7234 </st vrong></p>
						<p> <strike> Original Price : $689 </strike></p>
                                                <p> Discount percentage : 9 % </p>
                                                <p><font color = red ><strong>Discounted Price : </strong></font></p>
						<p>Intel Core i7 Processor</p>
						<p>8 GB DDR3L SDRAM</p>
						<p>1 TB HDD</p>
						<p>15 inches HD display</p>
