   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/21.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : Toshiba Satellite Fusion 15 L55W-C5257 </st vrong></p>
						<p> <strike> Original Price : $579.89 </strike></p>
