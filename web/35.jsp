   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/35.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : 2015 Newest Dell Chromebook </st vrong></p>
						<p> <strike> Original Price : $236.51 </strike></p>
                                                <p> Discount percentage : 10 % </p>
                                                <p><font color = red ><strong>Discounted Price : </strong></font></p>
						<p>Intel Celeron 2955U Processor</p>
						<p>4 GB DDR3L SDRAM</p>
						<p>4 GB SSD</p>
						<p>11 inches QHD display touch screen </p>
