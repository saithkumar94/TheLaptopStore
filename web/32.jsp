   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/32.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : Dell XPS 2-in-1 Ultrabook Laptop Computer</st vrong></p>
						<p> <strike> Original Price : $535.00</strike></p>
