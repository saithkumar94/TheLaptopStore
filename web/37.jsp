   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/37.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : Apple MacBook Pro MD101LL/A 13.3 </st vrong></p>
						<p> <strike> Original Price : $1,084.00 </strike></p>
