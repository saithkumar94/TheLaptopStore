   ...
   <nav class="navbar navbar-inverse fixed">
    ...
    <div class="modal-body">
                     <form role="form">
						...
						<img src="images/5.jpg" alt="Laptop Image" width="270" height="200">
                        </div>
                                 </td>
                                 <td>
                        <div class="form-group" >

						<p><strong>Name : HP Envy 15 </st vrong></p>
						<p> <strike> Original Price : $954.99 </strike></p>
                                                <p> Discount percentage : 10 % </p>
                                                <p><font color = red ><strong>Discounted Price : </strong></font></p>
						<p>6th Generation Intel Core i7 Processor</p>
