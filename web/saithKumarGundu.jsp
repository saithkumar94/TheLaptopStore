<%-- 
    Document   : saithKumarGundu
    Created on : Nov 16, 2015, 10:59:04 PM
    Author     : SaithKumar
--%>
...
<body>
   <nav class="navbar navbar-inverse fixed" id="header">
   ...
   <div class="container" id="section">
       <table>
           <tr>
               <td>
       <img src="images/saithkumar.jpg" alt="HTML5 Icon" style="width:200px;height:256px;">
               </td>
                         
               <td>
      <h1>Saith Kumar Gundu</h1>
               </td>
